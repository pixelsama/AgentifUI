...
export const defaultAboutConfig: AboutPageConfig = {
  ...
  mission: 'AgentifUI 致力于利用大型语言模型的力量，为企业和教育机构提供创新的应用解决方案。我们整合了多种模型供应商的能力，并基于 Dify 后端提供稳定、可靠的服务，帮助组织充分利用 AI 技术的价值。',
  valueCards: [
    {
      id: '1',
      title: '技术创新',
    ...
    },
    {
      id: '2',
      title: '数据安全',
      description: '支持私有化部署和严格的数据保护措施，确保企业数据的安全与隐私'
    },
    {
      id: '3',
      title: '灵活定制',
    ...
    },
    {
      id: '4',
      title: '知识增强',
      description: '通过 RAG 技术实现私有知识库的整合，增强模型的上下文感知能力'
    }
  ],
  buttonText: '开始探索',
