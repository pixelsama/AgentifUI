  ...
  return (
    <button
      className={cn(
        ...
        isDark
          ? 'border-stone-700 bg-stone-800 text-stone-300 hover:border-stone-600 hover:bg-stone-700' // 暗色：主背景 + 边框 -> 悬停稍亮
          : 'border-stone-300 bg-stone-100 text-stone-700 hover:border-stone-400 hover:bg-stone-200', // 亮色：主背景 + 边框 -> 悬停稍深
