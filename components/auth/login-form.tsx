    ...
    <div className="w-full max-w-md p-6 sm:p-8 space-y-6 sm:space-y-8 bg-stone-50 rounded-xl shadow-lg border border-stone-200 dark:bg-stone-900 dark:border-stone-800 transition-all font-serif">
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            />
            <label htmlFor="remember_me" className="ml-2 block text-sm text-gray-700 dark:text-gray-300 font-serif">
              记住我
            </label>
          </div>

          <div className="text-sm">
            <Link href="/forgot-password" className="font-medium text-stone-700 hover:text-stone-600 dark:text-stone-400 font-serif">
              忘记密码？
            </Link>
          </div>
        </div>
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-600 dark:text-gray-400 font-serif">
          还没有账号？{' '}
          <Link href="/register" className="font-medium text-stone-700 hover:text-stone-600 dark:text-stone-400 font-serif">
            立即注册
          </Link>
        </p>
      </div>
